var rule = {
    ...
    class_url:'1&2&3&4',
    play_parse: true,
    lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://110.42.2.247:880/analysis/json/?uid=2500&my=dmnoxzADHKMOQSXZ01&url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
    limit:6,
